...
namespace XComponent.SliderBar
{
	...
	{	
		...
		public virtual void OnValueChanged(long value)
		{
		...
		private void DrawTickTextLine(Graphics g, RectangleF drawRect, int tickFrequency, long minimum, long maximum, Color foreColor, Font font, Orientation orientation)
		{
		...
		/// <param name="orientation"></param>
		private void DrawTickLine(Graphics g, RectangleF drawRect, int tickFrequency, long minimum, long maximum, Color tickColor, Orientation orientation)
		{
			//Check input value
			if(maximum == minimum)
				return;
